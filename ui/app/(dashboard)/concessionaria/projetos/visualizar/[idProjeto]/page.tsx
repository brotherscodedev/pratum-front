...
export default function Page({ params }: { params: { idProjeto: number } }) {
  ...
  const [projetoEncontrado, setProjetoEncontrado] = useState<boolean>(true)
 ...
 useEffect(() => {
  ...
  return (
    <>
        ...
        <>
            ...
            {/* <BreadCrumb items={breadcrumbItems} />
              ...
              <div className="flex justify-between" >
                <Button
                      title="Volar para tela de Projetos"
                      onClick={() => navegarProjetos()}
                >
                  Voltar
                </Button>
      ...
      {!projetoEncontrado &&  <> <h1 className="text-2" > Não foi possivel acessar esse projeto! </h1> </> }
    </>
