...
const CadastrarUsuario = () => {
  ...
  const breadcrumbItems = [
    ...
    { title: "Cadastro de Usuario", link: `/admin/usuarios/cadastrar/` },
  ];
 ...
 function validarCpfCadastrado(cpf : string){
  ...
  const onSubmit: SubmitHandler<UsuarioFormValues> = async (data) => {
    if(validarFormulario()){
      ...
      console.log(form.getValues())
        ...
        toast({
          title: "Erro!",
          description: "Não foi possível Cadastrar o novo usuario.",
          variant: "destructive",
          position: "top"
        });
      }
  ...
  return (
    <>
      ...
      <Heading title="Cadastro de Usuario" description="" />
      {RenderFormulario()}
    </>
  );
}
